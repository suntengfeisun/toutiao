...
Source Database       : zmt_dev

Target Server Type    : MYSQL
Target Server Version : 50173
File Encoding         : 65001

Date: 2016-09-01 14:53:25
*/
...
-- ----------------------------
-- Table structure for zmt_content
-- ----------------------------
DROP TABLE IF EXISTS `zmt_content`;
CREATE TABLE `zmt_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=162295 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Table structure for zmt_guestbook
-- ----------------------------
DROP TABLE IF EXISTS `zmt_guestbook`;
CREATE TABLE `zmt_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for zmt_toutiao_url
-- ----------------------------
DROP TABLE IF EXISTS `zmt_toutiao_url`;
CREATE TABLE `zmt_toutiao_url` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=3779310 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for zmt_toutiaohao_url
-- ----------------------------
DROP TABLE IF EXISTS `zmt_toutiaohao_url`;
CREATE TABLE `zmt_toutiaohao_url` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `author` varchar(255) NOT NULL,
  `url` varchar(255) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=10080 DEFAULT CHARSET=utf8;
